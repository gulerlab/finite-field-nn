...
if __name__ == '__main__':
    ...
    if args.mode == 'scaled-vectorized-int-numpy':
        ...
        plt.xlabel('iteration')
        plt.ylabel('loss')
        plt.savefig('avg_loss_int_batch_128_vgg_cifar10.jpeg', dpi=300)
        plt.show()
        plt.figure()
        plt.plot(range(len(running_acc)), running_acc)
        ...
        plt.xlabel('iteration')
        plt.ylabel('loss')
        plt.savefig('loss_ff_batch_128_cifar10.jpeg', dpi=300)
        plt.show()
        plt.figure()
        plt.plot(range(len(running_acc)), running_acc)
        ...
        plt.xlabel('iteration')
        plt.ylabel('acc')
        plt.savefig('acc_ff_batch_128_cifar10.jpeg', dpi=300)
        plt.show()
        ...
        plt.xlabel('iteration')
        plt.ylabel('all loss')
        plt.savefig('loss_int_batch_128_vgg_cifar10.jpeg', dpi=300)
        plt.show()
        plt.figure()
        plt.plot(range(len(running_acc)), running_acc)
        ...
        plt.xlabel('iteration')
        plt.ylabel('acc')
        plt.savefig('acc_int_batch_128_vgg_cifar10.jpeg', dpi=300)
        plt.show()
        ...
        plt.xlabel('iteration')
        plt.ylabel('loss')
        plt.savefig('avg_loss_ff_batch_128_vgg_cifar10.jpeg', dpi=300)
        plt.show()
        plt.figure()
        plt.plot(range(len(running_curr_loss)), running_curr_loss)
        ...
        plt.xlabel('iteration')
        plt.ylabel('all loss')
        plt.savefig('loss_ff_batch_128_vgg_cifar10.jpeg', dpi=300)
        plt.show()
        plt.figure()
        plt.plot(range(len(running_acc)), running_acc)
        ...
        plt.xlabel('iteration')
        plt.ylabel('acc')
        plt.savefig('acc_ff_batch_128_vgg_cifar10.jpeg', dpi=300)
        plt.show()
        plt.figure()
