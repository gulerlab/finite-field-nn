...
def load_all_data_mnist(load_path, flatten=True):
    # transformations
    transform = Compose([
        ToTensor(),
...
def load_all_data_cifar10(load_path, flatten=True):
    # transformations
    transform = Compose([
        ToTensor(),
...
def load_all_data_apply_vgg_cifar10(load_path, flatten=True):
...
def load_all_data_fashion_mnist(load_path, flatten=True):
    # transformations
    transform = Compose([
        ToTensor(),
        Normalize((0.5,), (0.5,))
