...
#SBATCH --job-name="MNIST Integer Domain Training"
...
python int_training_pipeline.py -bs 256 -e 1 -dm 0 -qi 8 -qw 16 -qbs 8 -lr 7 -mcp ./model_configurations/custom_2_conv_2_linear_mnist.yaml
