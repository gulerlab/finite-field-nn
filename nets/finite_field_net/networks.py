...
class FiniteFieldPiNetNetworkDebug(Module):
    def __init__(self, quantization_bit_weight, prime, quantization_bit_input):
        super().__init__()
        self.__model = [
            FiniteFieldPiNetSecondOrderConvLayer(1, 6, (9, 9), quantization_bit_weight, prime, first_layer=True,
                                                 quantization_bit_input=quantization_bit_input),
            Flatten(),
            FiniteFieldPiNetSecondOrderLinearLayer(2400, 128, quantization_bit_weight, prime),
            FiniteFieldLinearLayer(128, 10, quantization_bit_weight, prime)
        ]
...
class FiniteFieldPiNetNetworkDebug2(Module):
    def __init__(self, quantization_bit_weight, prime, quantization_bit_input):
        super().__init__()
        self.__model = [
            FiniteFieldPiNetSecondOrderConvLayer(1, 3, (9, 9), quantization_bit_weight, prime, first_layer=True,
                                                 quantization_bit_input=quantization_bit_input),
            FiniteFieldPiNetSecondOrderConvLayer(3, 1, (9, 9), quantization_bit_weight, prime),
            Flatten(),
            FiniteFieldPiNetSecondOrderLinearLayer(144, 128, quantization_bit_weight, prime),
            FiniteFieldLinearLayer(128, 10, quantization_bit_weight, prime)
        ]
