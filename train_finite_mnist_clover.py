...
if DATASET_MODE == 0:
    train_data, train_label, test_data, test_label = load_all_data_mnist(load_path, QUANTIZATION_INPUT,
                                                                         QUANTIZATION_WEIGHT, PRIME, field,
                                                                         flatten=FLATTEN)
elif DATASET_MODE == 1:
...
model_arr = [
    layers.GaloisFieldLinearLayer(784, 128, QUANTIZATION_WEIGHT, PRIME, field, first_layer=True,
...
for epoch in range(EPOCH):
    ...
    for train_idx, (train_data_batch, train_label_batch) in enumerate(zip(train_data, train_label)):
        ...
        print('epoch: {}/{}, iteration: {}/{}, loss: {}'.format(epoch + 1, EPOCH, train_idx + 1, len(train_data),
                                                                curr_training_loss))
